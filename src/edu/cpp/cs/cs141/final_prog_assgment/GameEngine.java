...
public class GameEngine
{
	...
	/**
	 * Decides if the Map is completely revealed to the user. Only toggleable when the Player is taking their inital turn
	 */
	 ...
	 * location of Briefcase Invincibility = Player can not be Stabbed for 5
	 * FULL turns
	 * 
	...
	/**
	 * First Check if any Ninja is adjacent to Player, and then stabs
	 * Then move all Ninjas to a new Possible Location
	 * Then increment turnCount {@link #game}
	 */
