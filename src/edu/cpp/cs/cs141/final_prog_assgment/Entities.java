...
/**
 * This Super Class represents a Token on the Game Board, that has position,
 * rules on Spawn and Move locations.
 */
public abstract class Entities implements Serializable {
	 ...
	 * 
	 * @param x
	 *            The Horizonal Position, restricted between 0-8
	 * @param y
	 *            The Vertical Postion, restricted between 0-8
	 */
	...
	/**
	 * Verify that the specific Entity created, is allowed to spawn in the spot it
	 * exists in It is the Game Boards job to check if it is sharing a Space Verify
	...
	/**
	 * Change the current Position of this Entity, will not restrict entity to go
	 * out of bounds
	 * 
	 * @param direction
